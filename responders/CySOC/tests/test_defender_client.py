...
def test_disable_user_entra_success(fake_http):
    ...
    client.disable_user_entra(USER_ID)
...
def test_disable_user_entra_raises_on_error(fake_http):
    token_route(fake_http)
...
def test_disable_user_ad_success(fake_http):
    token_route(fake_http)
    fake_http.route(
    ...
    client.disable_user_ad(IDENTITY_ACCOUNT_ID, ONPREM_ID)
...
def test_disable_user_ad_raises_on_error(fake_http):
    token_route(fake_http)
    fake_http.route(
